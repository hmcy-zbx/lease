package com.zbx.lease.web.admin.controller.system;

import com.baomidou.mybatisplus.core.conditions.query.LambdaQueryWrapper;
import com.baomidou.mybatisplus.core.conditions.update.LambdaUpdateWrapper;
import com.baomidou.mybatisplus.extension.plugins.pagination.Page;
import com.zbx.lease.common.result.Result;
import com.zbx.lease.model.entity.SystemPost;
import com.zbx.lease.model.enums.BaseStatus;
import com.baomidou.mybatisplus.core.metadata.IPage;
import com.zbx.lease.web.admin.service.SystemPostService;
...
public class SystemPostController {
    ...
    private Result<IPage<SystemPost>> page(@RequestParam long current, @RequestParam long size) {
        ...
        IPage<SystemPost> pageList = service.page(page);
